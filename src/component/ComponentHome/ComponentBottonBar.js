    ...
    return (
        <div id="c-bottom-bar" className="bg-red-500 w-full py-6 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-left">
                ...
                <div className="ml-10 flex flex-col md:flex-row items-center md:items-start mt-4 space-y-4 md:space-y-0">
                    ...
                    <div className="flex items-center">
                        <img width={25} height={25} src={require("../../img/whatsapp (1).png")} alt="WhatsApp" className="ml-10 md:ml-3" />
                        <span className="font-bold text-white ml-3">
