                ...
                {items.map((item, index) => {
                    ...
                    return (
                        <div key={index} className={cardClass}>
                            <div className="w-64 h-80 md:w-72 md:h-96 bg-gradient-to-b from-black to-gray-900 text-white rounded-xl overflow-hidden shadow-xl border border-gray-700">
