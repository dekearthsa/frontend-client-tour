    ...
    return (
        <div className="bg-gradient-to-b from-gray-900 to-gray-800">
            ...
            <div className="container mx-auto px-4 py-12 md:py-20">
                <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 lg:h-[95vh] shadow-2xl rounded-xl p-8 md:p-16">
                    {isContact ? (
                        <>
                            <h2 className="fade-in duration-1500 ease-out transform transition-all text-4xl md:text-5xl font-extrabold mb-8 text-center ">
                                <div  className="fade-in duration-1000 ease-out transform transition-all text-5xl md:text-7xl font-extrabold text-white text-center px-4 tracking-wide" >
                                    {isGetInTouch}
                                </div>
                            </h2>
