                ...
                <div className="min-h-screen opacity-90">
                    ...
                    <div className="container mx-auto px-4 py-12">
                        ...
                        <div className="mt-12 on-set-detail-bg-product rounded-lg shadow-lg p-8 md:p-12 ">
                            ...
                            <div className="mb-8">
                                <div className='md:flex md:justify-between'>
                                    <div className='flex'>
                                        ...
                                        <h1 className="text-[20px] md:text-[25px] lg:text-[35px] font-extrabold text-gray-800 ml-4">{title}</h1>
                                    </div>
                            ...
                            <div className="mt-16">
                                <h2 className="text-base lg:text-2xl font-bold text-gray-800 flex items-center mb-6">
                            ...
                            <div className="mt-10">
                                <h2 className="text-[20px] lg:text-[35px] font-bold text-gray-800 flex items-center mb-6">
                                    ...
                                    <span className="ml-4 text-[20px] md:text-[25px]">Prices</span>
                                </h2>
